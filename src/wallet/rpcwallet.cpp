...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nReturns a new Ovato address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"    (string) The new ovato address\n"
            "\nExamples:\n" +
...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nDEPRECATED. Returns the current Ovato address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account ovato address\n"
            "\nExamples:\n" +
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 0)
        throw std::runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Ovato address, for receiving change.\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ovato address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" \"tabby\"") + HelpExampleRpc("setaccount", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\", \"tabby\""));

    LOCK2(cs_main, pwallet->cs_wallet);

    CBitcoinAddress address(request.params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Ovato address");
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ovato address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\"") + HelpExampleRpc("getaccount", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\""));
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\"         (string) a ovato address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n" +
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The ovato address to send to.\n"
            ...
            CURRENCY_UNIT + " to send. eg 0.1\n"
                            ...
                            "                             The recipient will receive less ovatos than you enter in the amount field.\n"
                            ...
                            "\nExamples:\n" +
            HelpExampleCli("sendtoaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 0.1") + HelpExampleCli("sendtoaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 0.1 \"donation\" \"seans outpost\"") + HelpExampleCli("sendtoaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 0.1 \"\" \"\" true") + HelpExampleRpc("sendtoaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The ovato address\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            HelpRequiringPassphrase(pwallet) + "\n"
                                               "\nArguments:\n"
                                               "1. \"address\"         (string, required) The ovato address to use for the private key.\n"
            ...
            "\nCreate the signature\n" + HelpExampleCli("signmessage", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" \"my message\"") +
            "\nVerify the signature\n" + HelpExampleCli("verifymessage", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" + HelpExampleRpc("signmessage", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\", \"my message\""));
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ovato address for transactions.\n"
            ...
            HelpExampleCli("getreceivedbyaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" + HelpExampleCli("getreceivedbyaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 0") +
            "\nThe amount with at least 6 confirmations\n" + HelpExampleCli("getreceivedbyaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 6") +
            "\nAs a json rpc call\n" + HelpExampleRpc("getreceivedbyaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\", 6"));
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a ovato address." +
            HelpRequiringPassphrase(pwallet) + "\n"
                                               "\nArguments:\n"
                                               ...
                                               "                       the spend.\n"
                                               "2. \"toaddress\"         (string, required) The ovato address to send funds to.\n"
            ...
            CURRENCY_UNIT + " (transaction fee is added on top).\n"
                            ...
                            "\nExamples:\n"
                            "\nSend 0.01 " +
            CURRENCY_UNIT + " from the default account to the address, must have at least 1 confirmation\n" + HelpExampleCli("sendfrom", "\"\" \"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n" + HelpExampleCli("sendfrom", "\"tabby\" \"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendfrom", "\"tabby\", \"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\", 0.01, 6, \"donation\", \"seans outpost\""));
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            HelpRequiringPassphrase(pwallet) + "\n"
                                               ...
                                               "    {\n"
                                               "      \"address\":amount   (numeric or string) The ovato address is the key, the numeric amount (can be string) in " +
            CURRENCY_UNIT + " is the value\n"
                            ...
                            "                           Those recipients will receive less ovatos than you enter in their corresponding amount field.\n"
            ...
            HelpExampleCli("sendmany", "\"\" \"{\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\":0.01,\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" + HelpExampleCli("sendmany", "\"\" \"{\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\":0.01,\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n" + HelpExampleCli("sendmany", "\"\" \"{\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\":0.01,\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\":0.02}\" 1 \"\" \"[\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\",\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\"]\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendmany", "\"\", \"{\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\":0.01,\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\":0.02}\", 6, \"testing\""));
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Ovato address: ") + name_);
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3) {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
                          ...
                          "Each key is a Ovato address or hex-encoded public key.\n"
                          "If 'account' is specified (DEPRECATED), assign address to that account.\n"

                          "\nArguments:\n"
                          "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
                          "2. \"keys\"         (string, required) A json array of ovato addresses or hex-encoded public keys\n"
                          "     [\n"
                          "       \"address\"  (string) ovato address or hex-encoded public key\n"
                          "       ...,\n"
                          "     ]\n"
                          "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

                          "\nResult:\n"
                          "\"address\"         (string) A ovato address associated with the keys.\n"

                          "\nExamples:\n"
                          "\nAdd a multisig address from 2 addresses\n" +
                          HelpExampleCli("addmultisigaddress", "2 \"[\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\",\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\"]\"") +
                          "\nAs json rpc call\n" + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\\\",\\\"oJtFfDVX9K2y4JAG4MFgRgtkyYjBYathnF\\\"]\"");
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The ovato address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The ovato address of the transaction. Not present for move transactions (category = move).\n"
            ...
            CURRENCY_UNIT + ". This is negative and only available for the 'send' category of transactions.\n"
                            ...
                            "}\n"
                            "\nExamples:\n" +
            HelpExampleCli("listsinceblock", "") + HelpExampleCli("listsinceblock", "\"2c5a0ff9e4d8a7cdece6cc0f11d8f949a0c58b2028fab79b90485a811253e217\" 6") + HelpExampleRpc("listsinceblock", "\"2c5a0ff9e4d8a7cdece6cc0f11d8f949a0c58b2028fab79b90485a811253e217\", 6"));
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            CURRENCY_UNIT + ". This is negative and only available for the \n"
                            ...
                            "      \"address\" : \"address\",          (string) The ovato address involved in the transaction\n"
            ...
            CURRENCY_UNIT + ". This is negative and only available for the \n"
                            ...
                            "\nExamples:\n" +
            HelpExampleCli("gettransaction", "\"c1700d6dd3e690866de56686e893cbe4e637eb5d84e3591cdfbbdbb0fcee49f8\"") + HelpExampleCli("gettransaction", "\"c1700d6dd3e690866de56686e893cbe4e637eb5d84e3591cdfbbdbb0fcee49f8\" true") + HelpExampleRpc("gettransaction", "\"c1700d6dd3e690866de56686e893cbe4e637eb5d84e3591cdfbbdbb0fcee49f8\""));
...
UniValue abandontransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "\nExamples:\n" +
            HelpExampleCli("abandontransaction", "\"c1700d6dd3e690866de56686e893cbe4e637eb5d84e3591cdfbbdbb0fcee49f8\"") + HelpExampleRpc("abandontransaction", "\"c1700d6dd3e690866de56686e893cbe4e637eb5d84e3591cdfbbdbb0fcee49f8\""));
...
UniValue walletpassphrase(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted() && (request.fHelp || request.params.size() != 2)) {
        throw std::runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending ovatos\n"
            "\nArguments:\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted() && (request.fHelp || request.params.size() != 0)) {
        throw std::runtime_error(
            ...
            "\nPerform a send (requires passphrase set)\n" + HelpExampleCli("sendtoaddress", "\"oTsdd7tRJh34uZDCitBgoYWCteHnJGR4nL\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!pwallet->IsCrypted() && (request.fHelp || request.params.size() != 1)) {
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending ovato\n" + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
    ...
    StartShutdown();
    return "wallet encrypted; Ovato server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending ovatos.\n"
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of ovato addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) ovato address\n"
            "      ,...\n"
            "    ]\n"
            ...
            CURRENCY_UNIT + "\n"
                            ...
                            "    \"vout\" : n,               (numeric) the vout value\n"
                            "    \"address\" : \"address\",    (string) the ovato address\n"
    ...
    if (request.params.size() > 2 && !request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Ovato address: ") + input.get_str());
            if (setAddress.count(address))
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "   {\n"
            "     \"changeAddress\"          (string, optional, default pool address) The ovato address to receive the change\n"
    ...
    if (!request.params[1].isNull()) {
        if (request.params[1].type() == UniValue::VBOOL) {
            ...
            if (options.exists("changeAddress")) {
                ...
                if (!address.IsValid())
                    throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid ovato address");
