...
const char * const BITCOIN_CONF_FILENAME = "ovato.conf";
const char * const BITCOIN_PID_FILENAME = "ovato.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ovato";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ovato";
#else
    // Unix
    return pathRet / ".ovato";
#endif
#endif
}
